...
func main() {
	...
	v1 := router.Group("/api/v1")
	{
		...
		{
			authRequired.GET("/learn/next-word", apiHandler.GetNextWord)
			authRequired.GET("/learn/peek-next-word", apiHandler.PeekNextWord)
			...
			authRequired.GET("/srs/info", apiHandler.GetSRSAlgorithmInfo)
